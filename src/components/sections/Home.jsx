const Home=()=>{
    return (
        <section id="Home" className="bg-gradient-to-b from-black-500 via-blue-700 to-black-500 rounded-2xl   min-h-screen flex items-center justify-center relative sm:pt-0 pt-20">
            <div className="  z-10 px-4 text-center ">
                ...
                <a href="#Projects" className=" rounded-4xl px-4 py-2 text-black font-medium transition duration-500 hover:-translate-y-1 bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 ">Projects</a>
